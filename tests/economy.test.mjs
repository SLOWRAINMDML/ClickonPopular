...
import { createDefaultState, GENERATORS, costFor, costForAmount, buyGenerator, registerTap, passiveRate, milestoneMultiplier, prestigeGain, ascend, buyRelic, offlineReward, dailyStatus, claimDaily } from '../src/game.js';
