const CACHE='lumen-loop-v1';
const ASSETS=['./','./index.html','./styles.css','./src/app.js','./src/game.js','./src/audio.js','./assets/icon.svg','./assets/lumen-core.svg','./manifest.webmanifest'];
